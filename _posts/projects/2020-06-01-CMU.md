...
<br>
The project uses the Cozmo robot along with the comzo-tools programming framework created by the [PI](https://github.com/touretzkyds/comzo-tools). Cozmo's low resolution camera provides 320×240 gray scale or 160×240 color images. We also expect to support additional robots as part of the effort to port cozmo- tools to new platforms.<br>
<br>
